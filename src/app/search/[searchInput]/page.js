...
export default function SearchResultPage({ params }) {
  ...
  //const processedSearchInput = params.replaceAll("%20", " ");
  const searchInput = params.searchInput || ""; // Access the specific parameter
  const processedSearchInput = searchInput.replace(/%20/g, " "); // Replace all "%20" with spaces
